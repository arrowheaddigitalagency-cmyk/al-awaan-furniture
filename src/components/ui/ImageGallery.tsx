      ...
      <div className={cn("columns-1 gap-4 sm:columns-2 lg:columns-3", className)}>
        {images.map((src, i) => (
          <button
            key={src}
            type="button"
            className="image-flash group mb-4 block w-full break-inside-avoid overflow-hidden rounded-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-bronze/50"
      ...
      {lightboxIndex !== null && (
        ...
        >
          ...
          <button
            ...
            className="absolute right-4 z-10 rounded-full bg-white/10 p-2 text-white hover:bg-white/20 md:right-16"
